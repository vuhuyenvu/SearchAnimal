...
<div class="modal fade" id="thembttvn" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{URL::to('/them-bao-ton-theo-nghi-dinh')}}" class="">
                {{ csrf_field() }}
...
<div class="modal fade" id="suabt" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{URL::to('/sua-bao-ton-theo-nghi-dinh')}}" class="">
                {{ csrf_field() }}
                <div class="modal-body">
                    <div class="card-body card-block">
...
<div class="modal fade" id="xoabt" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{URL::to('/xoa-bao-ton-theo-nghi-dinh')}}" class="">
                {{ csrf_field() }}
                <div class="modal-body">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Bảo Tồn Theo Nghị Định</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Bảo Tồn Theo Nghị Định</strong>
                    ...
                    <form method="post"  action="{{URL::to('tim-kiem-bao-ton-theo-nghi-dinh')}}" class="form-horizontal">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="" class="btn btn-primary btn-sm" data-toggle="modal"
                                            data-target="#suabt" onclick="sua_baotontheonghidinh()">Sửa</a> <a href=""
                                            class="btn btn-danger btn-sm" data-toggle="modal" data-target="#xoabt"
                                            onclick="xoa_baotontheonghidinh()">Xóa</a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
