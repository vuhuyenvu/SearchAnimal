    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="smallmodalLabel">Thêm Bảo Tồn</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post" action="{{URL::to('/them-bao-ton-theo-cites')}}" class="">
                {{ csrf_field() }}
...
<div class="modal fade" id="suabt" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{URL::to('/sua-bao-ton-theo-cites')}}" class="">
                {{ csrf_field() }}
                <div class="modal-body">
                    <div class="card-body card-block">
...
<div class="modal fade" id="xoabt" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{URL::to('/xoa-bao-ton-theo-cites')}}" class="">
                {{ csrf_field() }}
                <div class="modal-body">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Bảo Tồn Theo CITES</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Bảo Tồn Theo CITES</strong>
                    ...
                    <form method="post"  action="{{URL::to('tim-kiem-bao-ton-theo-cites')}}" class="form-horizontal">
                    ...
                    <div class="table-stats order-table ov-h">
                        <table class="table " id="table_baotontheocites">
                            <thead>
                                <tr>
                                    <th class="serial">#</th>
                                    <th>Mã Bảo Tồn</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="" class="btn btn-primary btn-sm" data-toggle="modal"
                                            data-target="#suabt" onclick="sua_baotontheocites()">Sửa</a> <a href=""
                                            class="btn btn-danger btn-sm" data-toggle="modal" data-target="#xoabt"
                                            onclick="xoa_baotontheocites()">Xóa</a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
...
function sua_baotontheocites() {
    var Index, table = document.getElementById('table_baotontheocites');
